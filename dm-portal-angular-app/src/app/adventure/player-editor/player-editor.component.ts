...
export class PlayerEditorComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public player: Player) {
    ...
    this.characterClass = this.player.characterClass;
  ...
  save() {
    ...
    this.player.characterClass = this.characterClass;
